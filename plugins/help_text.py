    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Developer', url='https://t.me/ShowcasE_Feedback'),
                    InlineKeyboardButton('Feedback', url='https://t.me/ShowcasE_Feedback')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/bots_showcase'),
                    InlineKeyboardButton('Source', url='https://github.com/ShowcaseBoss/Simple_Rename_bot')
                ]
            ]
        ),
